...
<a href={step.href} target ="_blank" class="p-4 sm:p-6 md:p-8 flex flex-col
    -4 rounded-lg border border-solid border-violet-700 text-center group
...
>
    ...
    <div class="flex-1 flex justify-between gap-4 items-center">
        <div class="ml-auto cursor-pointer hover:text-slate-950 duration-200 relative after:w-full after:h-full after:bg-white after:duration-200 hover:after:translate-x-full after:z-[-1] overflow-hidden"
        >
